...
layui.define('jquery', function(exports){
  ...
  ,NAV_TREE = 'layui-nav-tree',NAV_TREE_NOLINE="layui-nav-tree-noline", NAV_CHILD = 'layui-nav-child', NAV_MORE = 'layui-nav-more'
    ...
    var that = this, elemFilter = function(){
      ...
      ,nav: function(){
        var TIME = 200, timer = {}, timerMore = {}, timeEnd = {}, follow = function(bar, nav, index){
          ...
          if(nav.hasClass(NAV_TREE_NOLINE))return;
        ...
        $(NAV_ELEM + elemFilter).each(function(index){
          var othis = $(this)
          ,hoverBar= othis.attr("lay-hidebar")!=''
